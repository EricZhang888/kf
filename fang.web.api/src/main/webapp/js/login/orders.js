...
function genOrderHtml(a) {
    ...
    r += '<a class="order-info" href="/order/orderdetail?order_id=' + a.id + '">',
    ...
    var n = "";
    switch (n += a.roomBedroomCount ? a.roomBedroomCount + "室" : "1室",
    ...
    case 1:
        ...
        r += '<a class="now-pay" href="/order/orderpay?order_id=' + a.id + '">立即支付</a><a class="again-order" href="/apartment/detail?room_type_id=' + a.room_type_id + '">再次预订</a>';
        break;
    case 2:
    ...
    case 5:
        ...
        r += "</a>",
        r += '<div class="operate operate-db">',
        r += '<a class="remark-order" href="/order/orderdetail?order_id=' + a.id + '#remark">点评订单</a><a class="again-order" href="/Apartment/Detail?room_type_id=' + a.room_type_id + '">再次预订</a>';
        break;
    case 6:
